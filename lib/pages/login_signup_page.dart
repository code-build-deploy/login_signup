import 'package:digilocker/pages/login_page_background.dart';
...
class _LoginSignupPageState extends State<LoginSignupPage> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: new Text("Your details have been registered, please login."),
          actions: <Widget>[
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            LoginPageBackground(screenHeight: screenHeight,),
            _showForm(),
